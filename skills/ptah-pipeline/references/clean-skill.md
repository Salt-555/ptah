---
name: clean
description: Use when polishing a diff with KISS/DRY and local style.
version: 0.1.0
author: Brooklyn Nicholson (via OutThisLife/brooklyn-skills)
license: MIT
metadata:
  hermes:
    tags: [Code, Cleanup, PR, Style]
    related_skills: [ui-only, ui-system, pr-update, no-tropes]
---
...
- The user says /clean, "clean it up", or "tidy this"
- Before creating, updating, automerging a PR, or moving to the next one
- Mid-work, whenever the diff gets messy
